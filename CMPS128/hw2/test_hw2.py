...
contname = 'hw2' #Set your container name here
...
class TestHW2(unittest.TestCase):
    ...
    def spin_up_nodes(self):
        ...
        exec_string_main = "docker run -p 8083:8080 --net=mynet --ip=10.0.0.20 -e IP=10.0.0.20 -e PORT=8080 -d %s" % contname
        ...
        exec_string_forw1 = "docker run -p 8084:8080 --net=mynet --ip=10.0.0.21 -e IP=10.0.0.21 -e PORT=8080 -e MAINIP=10.0.0.20:8080 -d %s" % contname
        ...
        exec_string_forw2 = "docker run -p 8085:8080 --net=mynet --ip=10.0.0.22 -e IP=10.0.0.22 -e PORT=8080 -e MAINIP=10.0.0.20:8080 -d %s" % contname
    ...
    def test_a_put_nonexistent_key(self):
        #rn kvs returns 200 on putting a nonexistent key
    ...
    def test_c_get_nonexistent_key(self):
        #rn kvs returns 200 on getting a nonexistent key
    ...
    def test_e_del_nonexistent_key(self):
        #rn kvs returns 200 on deleting a non-existing key
    ...
    def test_g_get_deleted_key(self):
        #rn kvs returns 200 on getting a deleted key
    ...
    def test_h_put_deleted_key(self):
        #rn kvs returns 200 on putting a deleted key
    ...
    def test_k_get_nonexistent_key(self):
        #rn kvs returns 200 on getting a non-existent key
    ...
    def test_m_put_key_too_long(self):
        #need to check in server the length of the key & putting correct error code 201
    ...
    def test_o_put_key_without_value(self):
        #need to account for this in node, and correct error code 201
    ...
    def test_q_taking_down_secondary_instance(self):
        #will have to probe this directly
